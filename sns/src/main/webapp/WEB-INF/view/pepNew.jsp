					...
					<div class="card">
						...
						<div class="card-body">
							<div class="dt-responsive">
								...
								<form action="<%=request.getContextPath()%>/pep/add"
									method="post">
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="form-group">
												<label for="IdentityNo">NRIC Passport No:</label> <input
													type="text" id="IdentityNo" name="IdentityNo"
													class="form-control" placeholder="Identity No"
													required>
											</div>
											<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-sm-6 text-sm-end mt-3 mt-sm-0">
											...
											<a href="/sns/pep/list" class="btn btn-light-secondary">Cancel</a>
										</div>
									</div>
								</form>
							</div>
